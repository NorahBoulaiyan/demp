...
def process_log_file(cur, filepath):
    ...
    time_data = [df.ts.values, df.ts.dt.hour.values, df.ts.dt.day.values, df.ts.dt.weekofyear.values, df.ts.dt.month.values,df.ts.dt.year.values, df.ts.dt.weekday.values]
